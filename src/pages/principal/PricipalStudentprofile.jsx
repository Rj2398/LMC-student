              ...
              <a href="" onClick={(e) => { e.preventDefault();
				...
				<div className="table-responsive">
                  ...
                  {showFullDetails &&  !["not_started", "not_completed", "in_progress"].includes(studentProfileInfo?.baseline_status) && (
                    <Link to="/principal/student-baseline-assessment" state={{studentId: studentId, subjectId: selectedCourses?.length > 0 ? selectedCourses?.[0] : subjectId,}}>
                ...
                <tr key={index} className="lessons-list" style={ activeDropdown === "lessionDropdown"
                      ? {} : { display: "none" } } >
                  <td>&nbsp;</td>
