...
import { completeLesson, getLessionDetailSlice, getLessionSlice, getWhiteboard, lessionSubmit, retriveLesson, startLession, } from "../../redux/slices/student/lessionSlice";
...
//white board
const MyCustomUi = ({ attemptId, quizId, setQuizAnswers, simulateMatchingQuizAnswered, }) => {
...
const LessonDetail = () => {
  ...
  const handleMatchingLeftRadioChange = (quizId, leftItemId) => {
    ...
    if (correctMatchState.quizId === quizId || incorrectMatchState.quizId === quizId) {
      setCorrectMatchState({});
      setIncorrectMatchState({});
    }
  ...
  const handleSubmitQuizAnswers = () => {
    ...
    Object.keys(quizAnswers).forEach((quizId) => {
      ...
      if (!originalQuizContent) {
        console.warn(`Quiz content for ID ${currentQuizId} not found in lesson details.`);
        return;
      }
  ...
  if (!Array.isArray(lessionWiseDetails?.lesson?.contents)) {
    console.warn("lessionWiseDetails?.lesson?.contents is not an array or is missing. Using empty array for content.");
  }
    ...
    <>
      <div className="baseline-ass-wrp">
        <div className="back-btn mb-3">
          <Link to={`/student/subject-detail?subjectId=${subjectId}`} onClick={() => {
        ...
        <div className="less-details">
          ...
          <div className="less-details-in">
            {sortedContents?.map((contentItem, index) => {
              const itemKey = `${contentItem.type || "unknown"}-${contentItem.id || "noId"}-${contentItem.order || "noOrder"}-${index}`;
                        ...
                        return (
                          <>
                            ...
                            <div className="lesson-content-item text-content">
                              ...
                              {contentItem.image && (
                                <img src={contentItem.image} alt={`Lesson image ${contentItem.id}`} style={{ maxWidth: "100%", height: "554px" }} loading="lazy"/>
                              )}
                            </div>
                          </>
                        );
                          ...
                          <>
                            ...
                            <div className="lesson-content-item pdf-content" style={{ width: "40%" }}>
                              {contentItem.file_name && (
                                <PdfViewer pdfUrl={contentItem.file_name}
                          ...
                          return (
                            <>
                              ...
                              <div className="lesson-content-item quiz-content">
                                <h4 dangerouslySetInnerHTML={{ __html: contentItem.question,}}></h4>
                                <div>
                                  <CKEditor
                            ...
                            <>
                              ...
                              <div className="lesson-content-item quiz-content">
                                ...
                                >
                                  ...
                                  <div className="matching-in" style={{ flex: 1 }}>
