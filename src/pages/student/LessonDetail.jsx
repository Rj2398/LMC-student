...
const LessonDetail = () => {
  ...
  const checkAndCommitMatch = useCallback(
    (quizId, currentQuizState) => {
      console.log(currentQuizState, "current state*****");
...
// // --- Utility function to cyclically shift an array ---
// // This function moves the last element to the front, and shifts all others one position to the right.
// function cyclicallyShiftArray(array) {
//   if (!array || array.length <= 1) {
//     return array;
//   }
...
//                           // Collect all unique right-side items
//                           let allRightItems = Array.from(
//                             new Set(
//                               contentItem.matching_pairs
//                                 ? contentItem.matching_pairs.map(
...
//                           // --- FIX: Cyclically shift the array of right items ---
//                           allRightItems = cyclicallyShiftArray(allRightItems);
...
//   const feedback = Object.entries(matchFeedback).find(([key]) =>
//     key.startsWith(`${quizId}-${pair.id}-`)
//   )?.[1];
...
//   const feedback = Object.entries(matchFeedback).find(
//     ([key]) => key.includes(`${quizId}-`) && key.endsWith(`-${rightOption}`)
//   )?.[1];
...
//         // Set feedback for this match
//         setMatchFeedback((prev) => ({
//           ...prev,
//           [`${quizId}-${currentLeftSelection}-${currentRightSelection}`]: {
