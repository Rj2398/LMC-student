		...
		<div className="baseline-ass-wrp">
			...
			<div className="less-details">
				...
				<div className="less-details-in">
					...
					<video className="mt-3" width="100%" controls poster="../images/lesson-details/tumb_1.svg">
				...
				<div className="less-details-in">
					...
					<p>Imagining your future success and staying inspired to get what you want in life are strongly
						related to hope. Take a look at this short video to learn what some students hope for.</p>
					<video className="mt-3" width="100%" controls poster="../images/lesson-details/tumb_3.svg">
						<source src="https://www.w3schools.com/html/mov_bbb.mp4" type="video/mp4" />
						<source src="https://www.w3schools.com/html/mov_bbb.ogg" type="video/ogg" />
						Your browser does not support HTML video.
					</video>
				...
				<div className="less-details-in">
					...
					<p>Imagining your future success and staying inspired to get what you want in life are strongly
						related to hope. Take a look at this short video to learn what some students hope for.</p>
					<video className="mt-3" width="100%" controls poster="../images/lesson-details/tumb_2.svg">
						<source src="https://www.w3schools.com/html/mov_bbb.mp4" type="video/mp4" />
						<source src="https://www.w3schools.com/html/mov_bbb.ogg" type="video/ogg" />
						Your browser does not support HTML video.
					</video>
			...
			<div className="bottom-cta justify-content-end">
				<a href="javascript:void(0);" className="next-cta">Next Lesson <i className="fa-regular fa-arrow-right"></i></a>
			</div>
		</div>
	</>
  )
