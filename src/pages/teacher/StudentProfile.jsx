          ...
          {!showFullDetails && (
            <div className="back-btn ms-2">
              <a
                href=""
                onClick={(e) => {
                  e.preventDefault(); // This is the key line to prevent the refresh
          ...
          <table>
            ...
            <tr>
              ...
              <td>
                ...
                {showFullDetails && (
                  <Link to="/teacher/student-baseline-assessment">
                    <i className="fa-light fa-eye"></i> View Full Details
                  </Link>
                )}
              </td>
            ...
            <tr>
              ...
              <td>&nbsp;</td>
              <td>
                <div className="status">{studentProfileInfo?.lesson_overall_status?.replace(/_/g, " ")
              ...
              <td>
                ...
                {/* {showFullDetails && (
                  <Link to="/teacher/student-lesson-quiz">
                    <i className="fa-light fa-eye"></i> View Full Details
                  </Link>
                )} */}
              </td>
            ...
            {studentProfileInfo?.lesson_wise?.map((lesson, index) => (
              ...
              >
                    ...
                    <div className="progress">
                      <div
                        ...
                        style={{
                          ...
                          backgroundColor:
                            lesson.percentage < 70 ? "#F28100" : undefined,
                        }}
                        role="progressbar"
                ...
                {showFullDetails && (
                  <td>
                    <a href={`subject-lesson-detail/${lesson.lesson_id}`}>
                      <i className="fa-light fa-eye"></i> View Full Details
                    </a>
                  </td>
                )}
            ...
            <tr>
              ...
              <td>
                ...
                {showFullDetails && (
                  <Link to="/teacher/student-summative-assessment">
                    <i className="fa-light fa-eye"></i> View Full Details
                  </Link>
                )}
              </td>
