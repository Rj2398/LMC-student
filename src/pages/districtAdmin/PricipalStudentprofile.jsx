						...
						<table>
							...
							<tbody>
								...
								<tr>
									...
									<td>
										<div className={`status ${studentProfileInfo?.summative_status == "not_started" || studentProfileInfo?.summative_status == "locked" && "inactive"} ${["not_completed", "in_progress", "retake"].includes(studentProfileInfo?.summative_status) && "review"}`} >
