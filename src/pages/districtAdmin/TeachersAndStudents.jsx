...
import { getTeacherDetails, studentList, } from "../../redux/slices/principal/teacherAndStudentsSlice";
import { getSubjectLevel, getSubjectsByLevel, } from "../../redux/slices/principal/principalDashboardSlice";
import Select from "react-select";
import { getAllSchoolList } from "../../redux/slices/districtAdmin/districtSlice";

const TeachersAndStudents = () => {
  const dispatch = useDispatch();
  const { classLevels, subDashboard, allSubjects } = useSelector((state) => state.principalDashboard);
  const { teacherDetails, studentData } = useSelector((state) => state.teacherAndStudents);
  ...
  useEffect(() => {
    if (selectedLevel) {
      ...
      dispatch(getTeacherDetails({ level_id: selectedLevel, search: searchQuery, school_id:selectedSchool }));
    }
  ...
  const filteredTeacher = teacherDetails.filter((teacher) =>
