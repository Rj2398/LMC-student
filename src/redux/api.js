...
export const getEarnedCertificate = (formData) => API.post(`/get-user-certificate`, formData);
export const getWhiteboard = (formData) => API.post(`/submit-whiteboard-answer`, formData);
...
export const getStudentList = (formData) => API.post(`/get-students-class`, formData);
...
export const getStudentAnswers = (formData) => API.post(`/student-answers`, formData);
export const getMwlCategories = () => API.get(`/mwl-category`);
export const getMwlCategoryDetail = (formData) => API.post(`/mwl-details`, formData);
export const getLessonQuizAnswers = (formData) => API.post(`/student-lessons-review`, formData);
export const getTeacherProgressScore = (formData) => API.post(`/progress-score`, formData);
export const getTeacherSubjectQuizScore = (formData) => API.post(`/subject-wise-quiz-score`, formData);
export const getTeacherSubjectGraph = (formData) => API.post(`/subject-wise-graph`, formData);
export const getmwlLesson = (formData) => API.post(`/get-mwl-lessons`, formData);
export const getMwlContent = (formData) => API.post(`/mwl-content`, formData);


// ------------------------------------- Principal Panel Api -------------------------------------------------

export const getPrincipalSubDashboard = (formData) => API.post(`/principal-progress-dashboard`, formData);
export const getPrincipalSubjectsByLevel = (formData) => API.post(`/principal-classes-dashboard`, formData);
export const getPrincipalClassDetailBySubject = (formData) => API.post(`/class-details`, formData);
export const getPrincipalSubjectList = (formData) => API.post(`/get-subject`, formData);
export const getPrincipalLessionDetail = (formData) => API.post(`/view-lesson-details`, formData);
export const getPrincipalBaselineSummitiveQuiz = (formData) => API.post(`/baseline-and-summative-questions`, formData);
export const principalStudentProfilePerformance = (formData) => API.post(`/student-performance`, formData);
export const getPrincipalSubjectInfo = (formData) => API.post(`/subject-details`, formData);
export const getPrincipalStudentAnswers = (formData) => API.post(`/student-answers`, formData);
export const getPrincipalLessonQuizAnswers = (formData) => API.post(`/student-lessons-review`, formData);
...
export const getPrincipalProgressScore = (formData) => API.post(`/principal-progress-dashboard`, formData);
export const getPrinicpalSubjectGraph = (formData) => API.post(`/subject-performance`, formData);
export const getPrincipalSubjectQuizScore = (formData) => API.post(`/subject-quiz-score`, formData);
export const getPrinicipalTeacherTrainingScore = (formData) => API.post(`/teacher-training-score`, formData);
